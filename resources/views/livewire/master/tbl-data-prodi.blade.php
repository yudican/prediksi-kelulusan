<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            <livewire:table.data-prodi-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} data prodi</h5>
                    </div>
                    <div class="modal-body">
                        <x-text-field type="text" name="kode_prodi" label="Kode Prodi" />
                        <x-text-field type="text" name="nama_prodi" label="Nama Prodi" />
                        <x-select name="user_id" label="Kepala Prodi">
                            <option value="">Select Kepala Prodi</option>
